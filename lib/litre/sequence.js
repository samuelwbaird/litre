...
function capture_tween_property (target, property, final) {
	...
	// TODO: extend this to handling multiple fields within something complex like transform() properties
...
class coroutine {
	constructor (generator, apply_this, ...args) {
		this.generator = generator.apply(apply_this, args);
		this.yield = null;
		this.complete = false;
	}
...
class coroutine_manager {
	...
	run (generator, apply_this, ...args) {
		this.update_list.add(new coroutine(generator, apply_this, ...args));
	}
